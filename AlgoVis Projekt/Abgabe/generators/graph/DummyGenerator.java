...
public class DummyGenerator implements GeneratorBundle {
  ...
  public Vector<Generator> getGenerators() {
    ...
    generators.add(new KargersAlgorithm());
    generators.add(new KargersAlgorithm("resources/graph/KargersAlgorithm", Locale.GERMANY))
    generators.add(new KargersAlgorithm("resources/graph/KargersAlgorithm", Locale.US))
